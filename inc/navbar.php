        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
          ...
          <a class="dropdown-item d-flex align-items-center bg-success" onclick="cambiarColor(1)" href="#">
            <div class="dropdown-list-image mr-3">
              <img class="rounded-circle" src="https://cdn.shopify.com/s/files/1/0987/4294/products/conversation-idea-2_a592965a-13b8-49f8-a5dd-4bfc54343af2.jpg?v=1544473755" alt="">
              <div class="status-indicator bg-success"></div>
            </div>
            <div class="font-weight-bold">
              <div class="text-truncate">Color verde claro - "Success"</div>
            </div>
          </a>
          ...
          <a class="dropdown-item d-flex align-items-center bg-warning" onclick="cambiarColor(4)" href="#">
            <div class="dropdown-list-image mr-3">
               <img class="rounded-circle" src="https://cdn.shopify.com/s/files/1/0987/4294/products/conversation-idea-2_a592965a-13b8-49f8-a5dd-4bfc54343af2.jpg?v=1544473755" alt="">
              <div class="status-indicator bg-warning"></div>
            </div>
            <div>
              <div class="text-truncate">Color amarillo claro - "Warning"</div>
            </div>
          </a>
          <a class="dropdown-item d-flex align-items-center bg-danger" onclick="cambiarColor(5)" href="#">
            <div class="dropdown-list-image mr-3">
               <img class="rounded-circle" src="https://cdn.shopify.com/s/files/1/0987/4294/products/conversation-idea-2_a592965a-13b8-49f8-a5dd-4bfc54343af2.jpg?v=1544473755" alt="">
              <div class="status-indicator bg-danger"></div>
            </div>
            <div>
              <div class="text-truncate">Color rojo fuerte - "Danger"</div>
            </div>
          </a>
          <a class="dropdown-item d-flex align-items-center" href="#">
            <div class="dropdown-list-image mr-3">
            ...
            <div>
              <div class="text-truncate">Restablecer a cambios originales.</div>
              <div class="small text-gray-500">Autorizado por el doggy · ;)</div>
            </div>
          </a>
          <a class="dropdown-item text-center small text-gray-500" href="#">Más configuraciones</a>
        </div>
      </li>
